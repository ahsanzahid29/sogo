        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Add Spare Part Inventory</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="card-body pt-0">
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="col-md-3 mb-5">
                                        ...
                                        <a target="_blank" style="color:blue" class="form-control mb-2 mb-md-0" href="{{asset('public/files/csv/sparepart-inventory.csv')}}">View Demo</a>

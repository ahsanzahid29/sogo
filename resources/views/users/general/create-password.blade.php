    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    <!--begin::Form-->
                    <form class="form w-100" method="POST" action="{{ route('password.add') }}">
                        @csrf
                        <input type="hidden" name="recordid" value="{{ $user->uuid }}">
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="position-relative mb-3">
                                    <input class="form-control bg-transparent" type="email" placeholder="Email" name="email" value="{{ $user->email }}" readonly autofocus />
        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url('{{ asset('public/assets/media/misc/auth-bg.png') }}')">
            ...
            <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                <!--begin::Logo-->
                <a href="admin/index.php" class="mb-0 mb-lg-12">

...
<div class="container">
    <div class="header">
        ...
        <div>
            ...
            <input type="text" id="service-center-number" value="{{$invoiceDetail->phone}}" readonly>
        </div>
        <div>
            <label for="service-center-address">Service Center Contact Address:</label>
            <input type="text" id="service-center-address" value="{{ $invoiceDetail->shipping_address }}" readonly>
        </div>
    </div>
    ...
    <div class="total">
        <div>
            ...
            <input type="text" id="invoice-discount" value="{{$invoiceDetail->discount}}" readonly>
        </div>
